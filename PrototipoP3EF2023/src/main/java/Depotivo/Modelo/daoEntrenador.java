...
import Inventarios.Controlador.clsEntrenador;
import java.sql.*;
...
public class daoEntrenador {
    ...
    public List<clsEntrenador> consultaProductos() {
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        
        List<clsEntrenador> productos = new ArrayList<>();
        try {
            ...
            while (rs.next()) {
                ...
                clsEntrenador Productos = new clsEntrenador();
    ...
    public int ingresaProductos(clsEntrenador productos) {
        Connection conn = null;
        PreparedStatement stmt = null;
        int rows = 0;
        try {
    ...
    public int actualizaProductos(clsEntrenador productos) {
        Connection conn = null;
        PreparedStatement stmt = null;
        int rows = 0;
        try {
    ...
    public int borrarProductos(clsEntrenador productos) {
        Connection conn = null;
        PreparedStatement stmt = null;
        int rows = 0;
    ...
    public clsEntrenador consultaProductosPorNombre(clsEntrenador productos) {
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        try {
    ...
    public clsEntrenador consultaProductosPorId(clsEntrenador productos) {
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        try {
